...
export default function Bottom() {
  return (
    <div className="bottomBox">
      <div
        style={{ display: "flex", flexDirection: "row", alignItems: "center", flexWrap: "wrap", minWidth: 320, justifyContent: "center" }}
      >
      ...
      <div style={{ textAlign: "center", minWidth: 320 }}>
        <div>
          Copyright &copy; {new Date().getFullYear()} SNC All Right Reversed
        </div>
