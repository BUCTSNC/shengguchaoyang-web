...
=======
            { title: "学习资源", intro: "数字校园/信息门户", icon: <Bookshelf theme="outline" size="40" fill="#F2F2F2" />, src: "XXZY/XueXiZiYuan" },
            { title: "图书资源", intro: "图书馆/检索服务", icon: <DocumentFolder theme="outline" size="40" fill="#F2F2F2" />, src: "XXZY/XueXiZiYuan" },
            { title: "知网服务", intro: "中国知网", icon: <Edit theme="outline" size="40" fill="#F2F2F2" />, src: "XXZY/XueXiZiYuan" },
            { title: "自习教室", intro: "教学楼/图书馆/宿舍楼", icon: <Classroom theme="outline" size="40" fill="#F2F2F2" />, src: "XXZY/XueXiZiYuan" },
            { title: "学习网站", intro: "MOOC/虎课网/哔哩哔哩", icon: <Earth theme="outline" size="40" fill="#F2F2F2" />, src: "XXZY/XueXiZiYuan" },
            { title: "学习软件", intro: "墨墨背单词/专注森林", icon: <Word theme="outline" size="40" fill="#F2F2F2" />, src: "XXZY/XueXiZiYuan" }
>>>>>>> a2749147b1f6c01a0a40f992933ecc1a350d4bb8
        ]
    }
    const XYFG: CardInfo = {
