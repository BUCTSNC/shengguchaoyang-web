...
export function Feedback() {
    return <div style={{
        ...
        <div style={{
            width: "100%", backgroundColor: "#4470F5", color: "white", fontSize: "1.2rem", fontWeight: 1000, textAlign: "center", padding: 8
        }}>问题反馈</div>
        <img style={{ width: "80%" }} src={QR} />
        <p style={{ padding: 8}}>关注公众号，反馈您的问题，我们第一时间进行补充和修改。或者通过邮箱把你的问题发送到</p>
